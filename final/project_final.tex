...
\section{Experiments and results}
	...
	\subsection{Results}
		Our score constantly improved over the submissions, by perfecting the settings of our multilayer neural net.
		\vskip1ex
		\begin{center}
		\begin{tikzpicture}
		\centering
        ...
        The cost of our MNN reaches $10^{-2}$ for the 500th epoch, which is a good performance.
                \vskip2ex
		\begin{center}
		\begin{tikzpicture}
		\centering
